...
export const en: TranslationKey = {
  ...
  agent: {
    ...
    planLlmmNote: "AI-generated plan — verify parameters before submitting",
    ...
    example: {
      1: "用 RFD3 设计一个 80 残基的 binder，针对 hotspot A12/B34，采样 5 个",
      2: "Predict the structure of this protein with RF3",
      3: "用 ProteinMPNN 对 1abc.pdb 做序列设计，温度 0.2",
      4: "用 RFD3na 生成 3 个核酸结合蛋白",
    },
  },
  models: {
    rfd3: {
  ...
  settings: {
    title: "LLM Settings",
    subtitle: "Configure the AI model provider. The API key is stored only in your browser (localStorage) and never sent to any third party.",
    llm: {
      presets: "Quick Setup",
      ...
      keySet: "Set",
      keyMissing: "Not set",
      keyRequired: "API Key is required to use AI features",
      modelRequired: "Model name is required for this preset",
      notConfigured: "Disabled",
      apiKey: "API Key",
      apiKeyHelp: "Stored in browser localStorage only. Never uploaded to any server.",
      apiKeyPlaceholder: "sk-xxxxxxxxxxxxxxxx",
      saved: "Saved to browser!",
      backendDefaults: "Backend Default Config",
      backendDefaultsHelp: "Default values from backend environment variables (for reference).",
      priorityNote: "Frontend config takes priority and overrides backend defaults.",
