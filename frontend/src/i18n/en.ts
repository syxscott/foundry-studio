...
export const en: TranslationKey = {
  ...
  viewer: {
    ...
    zoom: "Zoom",
    reset: "Reset view",
    resetHint: "Re-center the structure",
    spinStart: "Auto-rotate",
    spinStop: "Stop rotation",
    spinHint: "Spin around the Y axis",
    screenshot: "Screenshot",
    screenshotHint: "Export the current view as a PNG",
    screenshotSaved: "Screenshot saved",
    screenshotFailed: "Screenshot failed",
    shortcutsHint: "Drag to rotate · Wheel to zoom · Shift+drag to pan · ESC to close",
  },
  environment: {
    title: "Environment",
    ...
    cleanOk: "Removed {{count}} file(s)",
    cleanFailed: "Cleanup failed",
    cleanNothingFound:
      "No removable checkpoint files were found.\nSearch paths:\n{{search_dirs}}\nInstall dir: {{install_dir}}\nIf your files are elsewhere, check FOUNDRY_STUDIO_CHECKPOINT_DIRS.",
  ...
  settings: {
    title: "LLM Settings",
    subtitle: "Configure the AI model provider. Design Session and other AI features require a real LLM to function properly.",
    llm: {
      title: "AI Model Configuration",
      provider: "Provider",
      baseUrl: "API Base URL",
      model: "Model",
      keyEnvVar: "API Key Env Var",
      timeout: "Timeout",
      keyPresent: "Configured",
      keyMissing: "Not set",
      notConfigured: "Disabled",
      configuredNoKey: "Provider configured but API key is missing. AI features are unavailable.",
      notConfiguredDetail: "No LLM configured. Design Session falls back to local heuristics and cannot call a real model.",
      apiKeyLabel: "Set API Key (writes to {{envVar}})",
      apiKeyHelp: "The value is saved to backend/.env and is never transmitted to third parties. Restart the backend for the change to take effect.",
      apiKeyPlaceholder: "sk-xxxxxxxxxxxxxxxx",
      saveKey: "Save",
      apiKeySaved: "Saved! Please restart the backend (uvicorn) for the change to take effect.",
      apiKeySaveFailed: "Failed to save",
      restartHint: "Tip: restart the backend (Ctrl+C then re-run uvicorn) to activate AI features.",
      manualConfig: "Manual config (via environment variables)",
      envExampleNote: "Edit backend/.env or set environment variables:",
      envLocation: "Saved to {dir}/.env",
    },
  },
  fileRoles: {
    structure: "structure",
  ...
  designSession: {
    ...
    newSessionDefault: "Untitled Session",
    newSessionPlaceholder: "Session name…",
    create: "Create",
    emptyChat: "Start a conversation to begin designing",
    emptyChatHint: "Describe your protein design goal and the AI will propose candidates",
    placeholder: "Describe your protein design goal, e.g. 'Design a 80-residue binder targeting hotspot A12/B34'…",
    ...
    round: {
      ...
      resolvedBy: "Resolved by {{resolver}}",
    ...
    compare: {
      ...
      close: "Close",
      metricsTitle: "Metrics Comparison",
      metrics: {
        title: "Metrics",
        property: "Property",
        length: "Length",
      ...
      candidatesCount: "{{count}} candidate(s)",
      noStructureAvailable: "Structure not available for comparison",
      hasStructure: "3D structure available",
      maxReached: "Maximum 3 candidates",
      maxReachedDetail: "You can compare up to 3 candidates at a time",
    ...
    roundCount: "{{count}} round(s)",
    continuePrompt: "Refine this candidate",
    error: {
      aiError: "AI Error",
      submitFailed: "Submit Failed",
    },
